...
func (m *FunctionMapper) ToProperties(function *Function) map[string]*structpb.Value {
	...
	var_AuditData := function.AuditData

	if var_AuditData != nil {
		var var_AuditData_mapped *structpb.Value

		var_AuditData_mapped = structpb.NewStructValue(&structpb.Struct{Fields: FunctionAuditDataMapperInstance.ToProperties(var_AuditData)})
...
func (m *FunctionMapper) FromProperties(properties map[string]*structpb.Value) *Function {
	...
	if properties["auditData"] != nil && properties["auditData"].AsInterface() != nil {
		...
		var mappedValue = FunctionAuditDataMapperInstance.FromProperties(var_AuditData.GetStructValue().Fields)
...
func (m *FunctionMapper) ToUnstructured(function *Function) unstructured.Unstructured {
	var properties unstructured.Unstructured = make(unstructured.Unstructured)
	properties["type"] = "nano/Function"
	...
	if var_AuditData != nil {
		...
		var_AuditData_mapped = FunctionAuditDataMapperInstance.ToUnstructured(var_AuditData)
		properties["auditData"] = var_AuditData_mapped
	}
...
type FunctionAuditDataMapper struct {
}

func NewFunctionAuditDataMapper() *FunctionAuditDataMapper {
	return &FunctionAuditDataMapper{}
}

var FunctionAuditDataMapperInstance = NewFunctionAuditDataMapper()

func (m *FunctionAuditDataMapper) New() *FunctionAuditData {
	return &FunctionAuditData{}
}

func (m *FunctionAuditDataMapper) ResourceIdentity() abs.ResourceIdentity {
	return abs.ResourceIdentity{
		Namespace: "nano",
		Name:      "Function",
	}
...
func (m *FunctionAuditDataMapper) ToProperties(functionAuditData *FunctionAuditData) map[string]*structpb.Value {
	var properties = make(map[string]*structpb.Value)

	var_CreatedBy := functionAuditData.CreatedBy
	...
	var_UpdatedBy := functionAuditData.UpdatedBy
	...
	var_CreatedOn := functionAuditData.CreatedOn
	...
	var_UpdatedOn := functionAuditData.UpdatedOn
...
func (m *FunctionAuditDataMapper) FromProperties(properties map[string]*structpb.Value) *FunctionAuditData {
	var s = m.New()
...
func (m *FunctionAuditDataMapper) ToUnstructured(functionAuditData *FunctionAuditData) unstructured.Unstructured {
	var properties unstructured.Unstructured = make(unstructured.Unstructured)
	properties["type"] = "nano/Function"
