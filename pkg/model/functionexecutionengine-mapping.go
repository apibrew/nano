...
type FunctionExecutionEngineMapper struct {
}

func NewFunctionExecutionEngineMapper() *FunctionExecutionEngineMapper {
	return &FunctionExecutionEngineMapper{}
}

var FunctionExecutionEngineMapperInstance = NewFunctionExecutionEngineMapper()

func (m *FunctionExecutionEngineMapper) New() *FunctionExecutionEngine {
	return &FunctionExecutionEngine{}
}

func (m *FunctionExecutionEngineMapper) ResourceIdentity() abs.ResourceIdentity {
...
func (m *FunctionExecutionEngineMapper) ToRecord(functionExecutionEngine *FunctionExecutionEngine) *model.Record {
	var rec = &model.Record{}
	rec.Properties = m.ToProperties(functionExecutionEngine)

	if functionExecutionEngine.Id != nil {
		rec.Id = functionExecutionEngine.Id.String()
	}

	return rec
}

func (m *FunctionExecutionEngineMapper) FromRecord(record *model.Record) *FunctionExecutionEngine {
	return m.FromProperties(record.Properties)
}

func (m *FunctionExecutionEngineMapper) ToProperties(functionExecutionEngine *FunctionExecutionEngine) map[string]*structpb.Value {
	var properties = make(map[string]*structpb.Value)

	var_Id := functionExecutionEngine.Id
	...
	var_Name := functionExecutionEngine.Name
	...
	var_Annotations := functionExecutionEngine.Annotations
	...
	var_CreatedBy := functionExecutionEngine.CreatedBy
	...
	var_UpdatedBy := functionExecutionEngine.UpdatedBy
	...
	var_CreatedOn := functionExecutionEngine.CreatedOn
	...
	var_UpdatedOn := functionExecutionEngine.UpdatedOn
	...
	var_Version := functionExecutionEngine.Version
...
func (m *FunctionExecutionEngineMapper) FromProperties(properties map[string]*structpb.Value) *FunctionExecutionEngine {
	var s = m.New()
